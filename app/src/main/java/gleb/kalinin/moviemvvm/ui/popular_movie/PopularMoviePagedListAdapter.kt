...
import gleb.kalinin.moviemvvm.data.api.POSTER_BASE_URL
...
class PopularMoviePagedListAdapter (public val context: Context) : PagedListAdapter<Movie, RecyclerView.ViewHolder>(MovieDiffCallBack()) {
    ...
    fun setNetworkState(networkState: NetworkState) {
        ...
        if (hadExtraRow != hasExtraRow) {
            if(hadExtraRow) {                           // had! ExtraRow is true and has! ExtraRow is False
                notifyItemRemoved(super.getItemCount()) // remove the progressbar at the end
            } else {                                    // has! ExtraRow is True and had! ExtraRow false
                notifyItemInserted(super.getItemCount()) // add the progressbar at the end
            }
        } else if (hasExtraRow && previousState != networkState) { // has! ExtraRow is true and had! ExtraRow true
